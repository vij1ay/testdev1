...
@tool
def check_appointment_availability(thread_id: str, specialist_id: Optional[str] = None,
...
@tool
def book_appointment(thread_id: str, specialist_id: str, slot_datetime: str, customer_id: str, reason: str) -> dict:
