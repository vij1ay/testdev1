"""
1. Place any json or txt files you want to use in the `casestudies` folder.
...
2. Run the populate script:
   ...
   * This processes all json and txt files in `casestudies/`
   * Stores embeddings and indexes in the `chroma/casestudies` folder
...
FILE_DATA_PATH = "casestudies"
CHROMA_DB_PATH = "chromastore" + os.sep + "casestudies"
os.makedirs(CHROMA_DB_PATH, exist_ok=True)


def main():
    """
    Main function to process and populate ChromaDB with documents from the casestudies folder.
